...
@pytest.mark.parametrize("compress_ratio", [1, 2])
@torch.inference_mode()
def test_prepare_indexer_indices_graph_replay(compress_ratio):
    selected = torch.randint(-1, 4096, (41, 2048), dtype=torch.int32, device="npu")
    positions = torch.full((41,), 4095, dtype=torch.int64, device="npu")
